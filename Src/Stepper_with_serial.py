"""
This is a library for Stepper Motor Controller.
The board uses Serial to communicate with a nano board, which is connected to the stepper motor.
It works with the old version of StepperCtrl.ino.
